<template>
    ...
    <div class="anchor-wrapper">
        ...
        <div v-for="item in hotAnchors" :key="item" class="anchor-item">
...
<script lang='ts'>
    import ArtistAndAnchorCover from '@/components/artist-anchor-cover/ArtistAnchorCover.vue';
