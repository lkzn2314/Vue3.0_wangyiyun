<template>
    <div class="footer-wrapper wrap-v2">
        <div class="left">
            <div class="link">
                <!-- rel="noopener noreferrer" 作用堵住 target="_blank"引发的钓鱼攻击 -->
                <a v-for="item in footerLinks" :key="item" :href="item.link" target="_blank" rel="noopener noreferrer">
                    {{item.title}}
        ...
        <ul class="right">
            <li class="item" v-for="item in footerImages" :key="item">
                <a class="link" :href="item.link" rel="noopener noreferrer" target="_blank"> </a>
